...
urlpatterns = [
    ...
    path('<str:plugin_id>/uninstall/', views.PluginUninstallView.as_view(), name='uninstall'),
    ...
    path('<str:plugin_id>/settings/', views.PluginSettingsView.as_view(), name='settings'),
] 