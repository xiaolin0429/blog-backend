...
class PluginInstallView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            return error_response(code=400, message="安装插件失败", data=error_data)
...
class PluginUninstallView(generics.DestroyAPIView):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return error_response(code=404, message="插件不存在")
...
class PluginSettingsView(generics.RetrieveUpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            if hasattr(e, "detail"):
                error_data = {"errors": e.detail}
            return error_response(code=400, message="更新配置失败", data=error_data)
