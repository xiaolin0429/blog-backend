...
from ..serializers import LogoutSerializer, LoginResponseSerializer
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                ...
                'remember': openapi.Schema(type=openapi.TYPE_BOOLEAN, description='记住我'),
            }
        ),
        responses={
        ...
        try:
            ...
            data = {
                ...
                "user": {
                    ...
                    "avatar": user.avatar.url if user.avatar and hasattr(user.avatar, 'url') else settings.DEFAULT_AVATAR_URL,
            ...
            200: openapi.Response(
                ...
                schema=openapi.Schema(
                    ...
                    properties={
                        ...
                        'message': openapi.Schema(type=openapi.TYPE_STRING, description='状态信息'),
