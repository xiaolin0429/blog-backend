...
class UserRegisterSerializer(TimezoneSerializerMixin, serializers.ModelSerializer):
    ...
    nickname = serializers.CharField(required=False, min_length=2, max_length=20, allow_null=True)
...
class UserProfileSerializer(TimezoneSerializerMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'username', 'email', 'nickname', 'avatar', 'bio', 'date_joined', 'last_login')
