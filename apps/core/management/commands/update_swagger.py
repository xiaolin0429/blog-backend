...
class Command(BaseCommand):
    ...
    def collect_urls(self, patterns, prefix=''):
        ...
        for pattern in patterns:
            if isinstance(pattern, URLPattern):
                ...
                if 'api/v1' in full_path and not any(x in full_path for x in ['swagger', 'redoc']):
    ...
    def handle(self, *args, **options):
        ...
        # 保存schema到文件
        output_file = Path(__file__).resolve().parent.parent.parent.parent.parent / 'static' / 'swagger.json'
